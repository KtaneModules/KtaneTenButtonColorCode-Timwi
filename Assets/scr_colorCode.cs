...
public class scr_colorCode : MonoBehaviour {
	...
	Color[] buttonColors = { new Color32 (255, 58, 58, 255), new Color32 (0, 226, 26, 255), new Color32 (0, 136, 255, 255) };
	...
	void Start () {
		...
		ruleList = new checkRules [4] { ((x) => solColors [x] == solColors [x + 1]), ((x) => solColors [x] == solColors [x + 5]), ((x) => solColors [x] == solColors [x + 1] && solColors [x] == solColors [x + 2] && solColors [x + 1] == solColors [x + 2]), ((x) => solColors [x] == solColors [x + 1] && solColors [x] == solColors [x + 5] && solColors [x] == solColors [x + 6] && solColors [x + 1] == solColors [x + 5] && solColors [x + 1] == solColors [x + 6] && solColors [x + 5] == solColors [x + 6]) };
		SetRules ();
	}
